...
const Product = () => {
  return (
    <main>
      <GoBack />
      <section className="px-6 lg:px-14 py-7 lg:py-12 bg-white rounded-lg">
        ...
        <article className="mt-14 mb-8 bg-off-white p-10 rounded-lg">
          ...
          <p className="text-base text-primary-gray">
            ...
            curabitur. A, nulla ac venenatis nunc et dui massa ac. Vitae non sed
            sollicitudin turpis rhoncus sed. Praesent ipsum, odio eu duis
            accumsan odio erat praesent ut. Lorem ipsum dolor sit amet,
            consectetur adipiscing elit. Etiam sed orci turpis volutpat egestas
            proin. Ut accumsan eu, non sem elit, curabitur. A, nulla ac
            venenatis nunc et dui massa ac. Vitae non sed sollicitudin turpis
            rhoncus sed. Praesent ipsum, odio eu duis accumsan odio erat
            praesent ut.
          </p>
